...
TEST_F(MathLibTestFixture, CalculateThirdAngleValidInput)
{
...
TEST_F(MathLibTestFixture, CalculateThirdAngleInvalidInput)
{
    ...
    EXPECT_THROW(MathLib::calculateThirdAngle(100, 100), std::invalid_argument);
}
